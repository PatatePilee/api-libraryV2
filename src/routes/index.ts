...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/book-collections',
            authenticateMiddleware([{"jwt":["read:book-collections"]}]),
        ...
        app.post('/book-collections',
            authenticateMiddleware([{"jwt":["write:book-collections"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController)),
        ...
        app.delete('/book-collections/:id',
            authenticateMiddleware([{"jwt":["delete:book-collections"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/books/:id',
            authenticateMiddleware([{"jwt":["read:books"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/books',
            authenticateMiddleware([{"jwt":["write:books"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/authors',
            authenticateMiddleware([{"jwt":["read:authors"]}]),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/authors',
            authenticateMiddleware([{"jwt":["write:authors"]}]),
            ...(fetchMiddlewares<RequestHandler>(AuthorController)),
